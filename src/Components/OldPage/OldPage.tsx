                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-md-3 col-sm-6 col-xs-12">
                            <img src="Images/Faces/Covercreateface.png" alt="CoverCreate" /><p className="description"><a href="#covercreatemain">A templating app that helps job seekers create cover letters</a></p>
                    ...
                    <div className="container-fluid" style={{ background: 'rgb(234, 223, 219)' }}>
                        <div className="LT">
                            ...
                            {/* <!-- <div style="max-width: 500px;" id="_giphy_ZVik7pBtu9dNS"></div> -->
                            <!-- <div className="flexholder">
                                <div className="flexslider">
                                <ul className="slides">
                                    <li>
                                    <img src="Images/LT/LT1.png">
                                    </li>

                                    <li>
                                    <img src="Images/LT/LT2.png">
                                    </li>

                                    <li>
                                    <img src="Images/LT/LT3.png">
                                    </li>

                                    <li>
                                    <img src="Images/LT/LT4.png">
                                    </li>

                                    <li>
                                    <img src="Images/LT/LT5.png">
                                    </li>
                        ...
                        <div className="container-fluid" style={{background: 'rgb(163,193,173);'}}>
                            <div className="CC">
                                ...
                                <h2><a href="https://covercreate.herokuapp.com/">This site is live</a></h2>
                                <a href="#top"><p className="back">Back to Top</p></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="container-fluid" style={{ background:"rgb(234, 223, 219);" }}>
                        <div className="TL">
                            ...
                            <h2><a href="http://learntech.herokuapp.com/">This site is live</a></h2>
                            <a href="#top"><p className="back">Back to Top</p></a>
                        </div>
                    </div>
                    ...
                    <div className="container-fluid" style={{ background: "rgb(163,193,173);" }}>
                        <div className="IA">
                            ...
                            <h2><a href="interview-schedule.herokuapp.com">This site is live</a></h2>
                            <a href="#top"><p className="back">Back to Top</p></a>
                        </div>
                    </div>
